...
QT_MOC_LITERAL(1, 6, 9), // "onClosing"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 8), // "onOpened"
QT_MOC_LITERAL(4, 26, 8), // "onClosed"
QT_MOC_LITERAL(5, 35, 9), // "startOpen"
QT_MOC_LITERAL(6, 45, 10), // "startClose"
QT_MOC_LITERAL(7, 56, 4), // "open"
QT_MOC_LITERAL(8, 61, 5) // "close"

    },
    "Doors\0onClosing\0\0onOpened\0onClosed\0"
    "startOpen\0startClose\0open\0close"
};
...
void Doors::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onClosing(); break;
        case 1: _t->onOpened(); break;
        case 2: _t->onClosed(); break;
        case 3: _t->startOpen(); break;
        case 4: _t->startClose(); break;
        ...
        {
            using _t = void (Doors::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Doors::onClosing)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Doors::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Doors::onOpened)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Doors::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Doors::onClosed)) {
                *result = 2;
                return;
            }
        }
